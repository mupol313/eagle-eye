...
class Edge:
    ...
    def _find_trades_for_stoploss_range(self, df, pair: str, stoploss_range) -> list:
        ...
        return result
    def find_1st(self,array, value, cmp_func):
        try:
            return next(i for i, v in enumerate(array) if cmp_func(v, value))
        except StopIteration:
            return -1

    def cmp_equal(self,a, b):
        return a == b

    def cmp_smaller(self,a, b):
        return a < b
    ...
    def _detect_next_stop_or_sell_point(self, buy_column, sell_column, date_column,ohlc_columns, stoploss, pair: str):
        ...
        while True:
            open_trade_index = self.find_1st(buy_column, 1, self.cmp_equal)
            ...
            stop_index = self.find_1st(ohlc_columns[open_trade_index:, 2], stop_price, self.cmp_smaller)
            ...
            sell_index = self.find_1st(sell_column[open_trade_index:], 1, self.cmp_equal)
