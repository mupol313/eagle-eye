...
class Exchange:
    ...
    def get_markets(self, base_currencies= [], quote_currencies= [],spot_only= False, margin_only= False, futures_only= False,tradable_only= True,active_only= False) -> Dict[str, Any]:
        markets = self.markets
        if not markets:
            raise OperationalException("Markets can not loaded with get markets")
    ...
    def market_is_tradable(self, market: Dict[str, Any]) -> bool:
        return (
            ...
            and (self.precisionMode != TICK_SIZE or market.get('precision', {}).get('price') > 1e-11)
    ...
    def validate_timeframes(self, timeframe: Optional[str]) -> None:
        ...
        if not hasattr(self._api, "timeframes") or self._api.timeframes is None:
            raise OperationalException(f"The ccxt library does not provide the list of timeframes "
